CONTACT EMAIL TEST
This is a test for automatically writing an contact email to the product owner through the website's About Me page.
...
Instructions:
    ...
    The program will work automatically until the email is sent.
    Check the email address on both ends to verify Email API functions properly.
