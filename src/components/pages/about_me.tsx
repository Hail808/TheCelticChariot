      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="flex flex-col items-center justify-center text-center space-y-4">
          ...
          <div className="flex gap-6 text-3xl text-green-700">
            <a href="https://www.instagram.com/thecelticchariot/" target="_blank" rel="noopener noreferrer">
              <FaInstagram className="hover:text-pink-600 transition" />
            </a>
            <a href="https://www.tiktok.com/@thecelticchariot" target="_blank" rel="noopener noreferrer">
